// 全局變數
        ...
        */
        ...
        function updateViewerCount(count) {
            ...
            if (viewerCountElement) viewerCountElement.textContent = count;
            if (chatViewerCountElement) chatViewerCountElement.textContent = count;
        }
        ...
        function toggleUserMenu() {
            ...
            menu.innerHTML = `
                <div class="menu-user-info">
                    <div class="menu-user-name">${currentUser ? currentUser.displayName : '訪客'}</div>
                </div>
